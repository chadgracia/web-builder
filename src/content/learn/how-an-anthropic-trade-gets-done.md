---
title: "How an Anthropic Trade Actually Gets Done"
description: "A behind-the-scenes, T-minus walkthrough of how a real Anthropic secondary trade comes together — from the vanishing supply and the two-layer pivot to winnowing 200 buyers down to one and getting to the close."
date: "March 2026"
---
...
1. I remove around 50 because I don't think the size is a match; this trade is no less than $2.5M and that's not appropriate for all my clients.
2. I remove another 50 who have mentioned they won't touch a 2-layer structure.
3. I remove the "ghosts": anyone who has gone silent in the past after claiming interest. I don't want to waste a precious slot on non-responsive buyers.
4. I remove another ten who got flagged in my system because they showed some eyebrow-raising behavior. I prioritize buyers who are responsive, aligned on structure, and current on compliance requirements.
...
1. **Compliance is not optional.** Take care of compliance before the trade or you aren't in the room.
2. **Professionalism is currency.** If you aren't reliable, you won't even be shown the trades you're looking for.
3. **Be a problem solver.** Whether it's an NDA for proof of shares or an LP restructure for a QP limit, the deal only closes if you find a way through the obstacles.

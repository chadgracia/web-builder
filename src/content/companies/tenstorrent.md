...
- An acquisition at a reported range is not a floor. If talks collapse, secondary pricing can retrace quickly.
- Acquisitions of venture-backed companies pay out according to the waterfall — preference stacks, note conversion mechanics, and milestone structures can make outcomes differ meaningfully by share class.
...
- **Transfer restrictions.** The company can block or delay secondary transfers; many trades settle as forward contracts or through existing SPVs instead.
- **Information asymmetry.** Sellers may hold information buyers don't. Work with intermediaries who disclose what is and isn't confirmable.
- **Scarcity pricing.** Post-Qualcomm-report, asks have moved. Whether they're justified depends entirely on whether a deal closes — which nobody selling can promise you.
